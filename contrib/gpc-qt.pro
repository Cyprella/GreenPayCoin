...
RESOURCES += src/qt/gpc.qrc src/qt/gpc_locale.qrc

TRANSLATIONS += src/qt/locale/gpc_bg.ts \
                src/qt/locale/gpc_de.ts \
                src/qt/locale/gpc_en.ts \
                src/qt/locale/gpc_es.ts \
                src/qt/locale/gpc_fi.ts \
                src/qt/locale/gpc_fr.ts \
                src/qt/locale/gpc_it.ts \
                src/qt/locale/gpc_ja.ts \
                src/qt/locale/gpc_pl.ts \
                src/qt/locale/gpc_pt.ts \
                src/qt/locale/gpc_ru.ts \
                src/qt/locale/gpc_sk.ts \
                src/qt/locale/gpc_sv.ts \
                src/qt/locale/gpc_vi.ts \
                src/qt/locale/gpc_zh_CN.ts \
                src/qt/locale/gpc_zh_TW.ts
