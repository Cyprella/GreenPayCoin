Contributing to GreenPayCoin Core
============================

The GreenPayCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GreenPayCoin Core project, and is not to be
confused with overall GreenPayCoin Network Protocol consensus changes.

Whether a pull request is merged into GreenPayCoin Core rests with the project merge
...
Patches that change GreenPayCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the GreenPayCoin consensus, it must have been
...
The project leader is the release manager for each GreenPayCoin Core release.
