...
In order to support loading of multiple wallets in gpc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gpc.cpp.
...
Changes to gpc.cpp
----------------------
gpc.cpp is the entry point into gpc-qt, and as such, will require some minor modifications to provide hooks for
