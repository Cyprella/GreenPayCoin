...
This mechanism has been integrated into Bitcore-Node-GreenPayCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GreenPayCoin-Project/insight-api-gpc#web-socket-api](https://github.com/GreenPayCoin-Project/insight-api-gpc#web-socket-api) 
* API: [https://github.com/GreenPayCoin-Project/insight-api-gpc#swifttx-transactions](https://github.com/GreenPayCoin-Project/insight-api-gpc#swifttx-transactions)
...
By default, the GreenPayCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GreenPayCoin Core daemon:
