...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("GreenPay Coin Wallet");
    ...
    QString copyrightTextPivx = QChar(0xA9) + QString(" 2015-2018 ").arg(COPYRIGHT_YEAR) + QString(tr("The PIVX Core developers"));
	  QString copyrightTextGPC = QChar(0xA9) + QString(tr(" 2019 The GreenPay Coin developers"));
	...
	pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextGPC);
