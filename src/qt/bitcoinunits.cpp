...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case GPC:
            return QString("tGPC");
        case mGPC:
            return QString("mtGPC");
        case uGPC:
            return QString::fromUtf8("μtGPC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case GPC:
            return QString("GPC");
        case mGPC:
            return QString("Milli-GPC (1 / 1" THIN_SP_UTF8 "000)");
        case uGPC:
            return QString("Micro-GPC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case GPC:
            return QString("TestGPCs");
        case mGPC:
            return QString("Milli-TestGPC (1 / 1" THIN_SP_UTF8 "000)");
        case uGPC:
            return QString("Micro-TestGPC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
