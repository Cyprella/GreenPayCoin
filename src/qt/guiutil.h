...
/** Utility functions used by the GreenPayCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render GreenPayCoin addresses in monospace font
...
// Parse "gpc:" URI into recipient object, return true on successful parsing
