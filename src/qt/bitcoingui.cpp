...
QFontDatabase::addApplicationFont(":/fonts/gpc_font");

    QString windowTitle = tr("GreenPayCoin Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GreePayCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and GPC: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GreenPayCoin Wallet"), this);
    aboutAction->setStatusTip(tr("Show information about GreenPayCoin Wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GreenPayCoin Wallet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GreenPayCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GreenPayCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a GPC: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the GreenPayCoin Core help message to get a list with possible GreenPayCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GreenPayCoin Wallet client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GreenPayCoin network", "", count));
}
...
{
    QString strTitle = tr("GreenPayCoin Wallet"); // default title
    ...
    // Append title to "GreenPayCoin Wallet- "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
