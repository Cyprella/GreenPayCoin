...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Greenpaycoin Core gpc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gpc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gpc transaction") + "\n" +
                               "  gpc-tx [options] -create [commands]   " + _("Create hex-encoded gpc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gpc transaction
