...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop GreenPayCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "GreenPayCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Greenpaycoin features */
        {"gpc", "masternode", &masternode, true, true, false},
        {"gpc", "listmasternodes", &listmasternodes, true, true, false},
        {"gpc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gpc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gpc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gpc", "masternodedebug", &masternodedebug, true, true, false},
        {"gpc", "startmasternode", &startmasternode, true, true, false},
        {"gpc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gpc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gpc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gpc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gpc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gpc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gpc", "mnbudget", &mnbudget, true, true, false},
        {"gpc", "preparebudget", &preparebudget, true, true, false},
        {"gpc", "submitbudget", &submitbudget, true, true, false},
        {"gpc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gpc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gpc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gpc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gpc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gpc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gpc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gpc", "checkbudgets", &checkbudgets, true, true, false},
        {"gpc", "mnsync", &mnsync, true, true, false},
        {"gpc", "spork", &spork, true, true, false},
        {"gpc", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"gpc", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use gpcd, or the -server option to gpc-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> gpc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:38798/\n";
}
